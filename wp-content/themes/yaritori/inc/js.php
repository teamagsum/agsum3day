...
class P2_JS {
	...
	static function init() {
		...
		#wp_register_script(
		#	'jquery-ui-widget',
		#	P2_JS_URL .'/jquery.ui.widget.js',
		#	array( 'jquery' ),
		#	'20140612'
		#);
		wp_register_script(
			'jquery-fileupload',
			P2_JS_URL .'/jquery.fileupload-all.min.js',
	...
	static function enqueue_scripts() {
		...
		$depends = array( 'jquery', 'utils', 'jquery-color', 'comment-reply',
			'scrollit', 'wp-locale', 'p2-spin','jquery-fileupload');
    ...
    global $user_ID;/*PM HS */
		...
		$page_options['is_category'] = (int)is_category();/*PM HS */
		$page_options['is_first_category'] = (int)(is_category() && !is_paged() );/*PM HS*/
		$page_options['is_user_logged_in'] = (int)is_user_logged_in();
		$page_options['uid'] = (int)$user_ID;/*PM HS */
...
?>
		<script type="text/javascript">
			...
			var updateRate              = "60000"; // 60 seconds
			...
			var isCategory             = <?php echo $page_options['is_category']  /*PM HS*/ ?>;
			var isFirstCategory             = <?php echo $page_options['is_first_category']  /*PM HS*/ ?>;
			...
			var uid          = <?php echo $page_options['uid']; /*PM HS */ ?>;
