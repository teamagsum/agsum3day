...
/*PM HS 20140606*/
if ( p2_user_can_post() && (is_home() or is_category()) ) :
?>
...
グループ『<?php echo $thisCatName; ?>』の更新 <?php if ( p2_get_page_number() > 1 ) printf( __( 'Page %s', 'p2' ), p2_get_page_number() ); ?>
...
<?php
/*add by PM HS*/
if(function_exists("pm_show_order_choice")){
	pm_show_order_choice();
}
?>
		<ul id="postlist">
