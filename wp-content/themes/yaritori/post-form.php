...
<span id="more-buttons"><a href="#">分割タグ挿入</a>&nbsp;<span data-icon="&#xe14c;" style="color:#3478E3;"></span></span>
				<?php if ( current_user_can( 'upload_files' ) ): ?>
				<span class="fileinput-button">ファイルアップロード<input id="fileupload" type="file" name="uploadfile"> <span data-icon="&#xe0bc;"></span></span>
...
<?php do_action('post-form-after');//PM HS 1026 ?>
				</div>
